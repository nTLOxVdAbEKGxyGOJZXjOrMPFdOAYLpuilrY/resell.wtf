...
function V(e, r, o, s, l, i, a = [-1]) {
    ...
    if (d.ctx = o ? o(e, r.props || {}, ((t, n, ...c) => {
            ...
            return d.ctx && l(d.ctx[t], d.ctx[t] = r) && (!d.skip_bound && d.bound[t] && d.bound[t](r), p && I(e, t)), n
...
function G(e, n = t) {
    ...
    return {
        ...
        subscribe: function (o, l = t) {
            const i = [o, l];
            return r.push(i), 1 === r.length && (c = n(s) || t), o(e), () => {
                const t = r.indexOf(i); - 1 !== t && r.splice(t, 1), 0 === r.length && (c(), c = null)
            }
        }
    }
}
...
const st = document.querySelector(".js-tv"),
    ...
    mt = {
        ...
        9: {
            type: "webcam",
            displayName: "I_CAN_SEE_YOU_I_CAN_SEE_YOU_I_CAN_SEE_YOU_I_CAN_SEE_YOU"
        }
    },
    ht = Object.keys(mt),
    vt = function (e, n, o) {
...
function wt() {
    const t = l(ut) - .06666666666666667;
    t < 0 || ut.set(t)
}
...
function Ot(e) {
    ...
    return {
        c() {
            n = m("div"), c = m("video"), r = v(), o = m("div"), s = m("div"), s.innerHTML = '', l = v(), i = m("div"), a = h(e[2]), y(c, "class", "tv-video svelte-60jbj3"), y(c, "channel", "camera"), c.autoplay = !0, y(s, "class", "rec svelte-60jbj3"), y(i, "class", "counter"), y(o, "class", "rec-wrapper big-text glitchy-text svelte-60jbj3"), $(n, "visually-hidden", !e[0] || e[3] === ct)
        },
        m(t, f) {
            d(t, n, f), u(n, c), e[5](c), u(n, r), u(n, o), u(o, s), u(o, l), u(o, i), u(i, a)
        },
        p(t, [e]) {
            4 & e && b(a, t[2]), 9 & e && $(n, "visually-hidden", !t[0] || t[3] === ct)
        },
        i: t,
        o: t,
        d(t) {
...
function Ft(e) {
    ...
    return {
        c() {
            n = m("video"), r = m("source"), s = m("source"), r.src !== (o = "/assets/videos/channel-" + e[4].displayName + ".mp4") && y(r, "src", o), y(r, "type", "video/mp4"), s.src !== (l = "/assets/videos/channel-" + e[4].displayName + ".mp4") && y(s, "src", l), y(s, "type", "video/mp4"), y(n, "class", "tv-video"), y(n, "channel", i = e[4].number), n.playsInline = !0, n.loop = !0, void 0 === e[2] && _((() => e[10].call(n))), $(n, "visually-hidden", !e[1] || e[3] === ct)
        },
        m(t, c) {
            d(t, n, c), u(n, r), u(n, s), e[8](n), isNaN(e[5]) || (n.volume = e[5]), a || (p = [g(n, "volumechange", e[9]), g(n, "durationchange", e[10]), g(n, "canplay", e[6])], a = !0)
        },
        p(t, [e]) {
            16 & e && r.src !== (o = "/assets/videos/channel-" + t[4].displayName + ".mp4") && y(r, "src", o), 16 & e && s.src !== (l = "/assets/videos/channel-" + t[4].displayName + ".mp4") && y(s, "src", l), 16 & e && i !== (i = t[4].number) && y(n, "channel", i), 32 & e && !isNaN(t[5]) && (n.volume = t[5]), 10 & e && $(n, "visually-hidden", !t[1] || t[3] === ct)
        },
        i: t,
        o: t,
        d(t) {
...
function Pt(t, e, n) {
    let c, r, o, s;
    i(t, ft, (t => n(3, c = t))), i(t, vt, (t => n(4, r = t))), i(t, dt, (t => n(7, o = t))), i(t, ut, (t => n(5, s = t)));
    const l = A();
    let a, u, d = !1;
    return t.$$.update = () => {
...
function It(t) {
    ...
    return ~(n = u(t)) && (r = a[n] = i[n](t)), s = new _t({}), {
        c() {
        ...
        p(t, [o]) {
            ...
            n = u(t), n === s ? ~n && a[n].p(t, o) : (r && (P = {
                ...
                a[s] = null
            })), P.r || c(P.c), P = P.p), ~n ? (r = a[n], r ? r.p(t, o) : (r = a[n] = i[n](t), r.c()), H(r, 1), r.m(e, null)) : r = null)
        },
        i(t) {
...
function Vt(t, e, n) {
    let c, r, o, s, l;
    i(t, ft, (t => n(2, c = t))), i(t, vt, (t => n(0, r = t))), i(t, dt, (t => n(3, o = t))), i(t, at, (t => n(4, s = t))), i(t, pt, (t => n(5, l = t)));
    let u, d = !1;
    ...
    return C((() => {
        ...
        4 & t.$$.dirty && (c === ct ? (f(), Y.classList.add("loading-channel"), u = Date.now()) : f()), 1 & t.$$.dirty && (e = r, d && (Q((() => {
            ...
            value: e.displayName
        }))), 8 & t.$$.dirty && Y.setAttribute("channel", `${o}`), 16 & t.$$.dirty && Y.classList.toggle("hide-content", !s), 32 & t.$$.dirty && Y.classList.toggle("loading-page", l === ct), 36 & t.$$.dirty && (l === ct || c === ct ? Rt() : Bt && (Bt.stop(), Bt = null))
    }, [r, p, c, o, s, l]
}
class Wt extends W {
    constructor(t) {
...
function Kt(e) {
    let n, r, o, s, l, i, a, h, b, $, w, x, E, C, A, k, N, S, T, j, L, _, O, M, q, D, F, P, H, B, R, U, z, I, V, W, J, G, K, Q, X, Y, Z = {
            length: 9
        },
        tt = [];
    ...
    return {
        c() {
            n = m("div"), r = m("div"), o = m("div"), s = m("div"), l = m("div"), i = m("div"), a = m("button"), a.textContent = "REMOTE\n              OFF", h = v(), b = m("span"), b.textContent = "SPACE OFF", $ = v(), w = m("div"), x = m("button"), x.textContent = "▲", E = v(), C = m("div"), A = m("button"), A.textContent = "▼", k = v(), N = m("span"), N.textContent = "VOLUME", S = v(), T = m("div"), j = m("button"), j.textContent = "MUTE", L = v(), _ = m("span"), _.textContent = "MUTE", O = v(), M = m("div"), q = m("button"), q.textContent = "▲", D = v(), F = m("div"), P = m("button"), P.textContent = "▼", H = v(), B = m("span"), B.textContent = "CHANNEL", R = v(), U = m("div");
            for (let t = 0; t < tt.length; t += 1) tt[t].c();
            z = v(), I = m("div"), V = m("button"), V.textContent = "0", W = v(), J = m("div"), G = m("button"), G.textContent = "SHOW/HIDE", K = v(), Q = m("div"), Q.innerHTML = '<img loading="lazy" src="/assets/images/kiwivision.svg" alt="kiwivision" width="103" height="10" class="svelte-1vrpccc"/> \n          <br/> \n          <span>COMPUTER SPACE COMMAND</span>', y(a, "class", "hide-text svelte-1vrpccc"), y(b, "class", "svelte-1vrpccc"), y(i, "class", "control onoff svelte-1vrpccc"), y(x, "class", "svelte-1vrpccc"), y(w, "class", "control vol up svelte-1vrpccc"), y(A, "class", "svelte-1vrpccc"), y(N, "class", "svelte-1vrpccc"), y(C, "class", "control vol down svelte-1vrpccc"), y(j, "class", "hide-text svelte-1vrpccc"), y(_, "class", "svelte-1vrpccc"), y(T, "class", "control mute svelte-1vrpccc"), y(q, "class", "svelte-1vrpccc"), y(M, "class", "control ch up svelte-1vrpccc"), y(P, "class", "svelte-1vrpccc"), y(B, "class", "svelte-1vrpccc"), y(F, "class", "control ch down svelte-1vrpccc"), y(V, "class", "svelte-1vrpccc"), y(I, "class", "control number svelte-1vrpccc"), y(G, "class", "showhide svelte-1vrpccc"), y(J, "class", "control showhide svelte-1vrpccc"), y(U, "class", "numbers svelte-1vrpccc"), y(l, "class", "buttons svelte-1vrpccc"), y(Q, "class", "brand svelte-1vrpccc"), y(s, "class", "inner svelte-1vrpccc"), y(o, "class", "remote svelte-1vrpccc"), y(r, "class", "wrapper svelte-1vrpccc"), y(n, "class", "perspective svelte-1vrpccc")
        },
        m(t, c) {
            d(t, n, c), u(n, r), u(r, o), u(o, s), u(s, l), u(l, i), u(i, a), u(i, h), u(i, b), u(l, $), u(l, w), u(w, x), u(l, E), u(l, C), u(C, A), u(C, k), u(C, N), u(l, S), u(l, T), u(T, j), u(T, L), u(T, _), u(l, O), u(l, M), u(M, q), u(l, D), u(l, F), u(F, P), u(F, H), u(F, B), u(l, R), u(l, U);
            for (let t = 0; t < tt.length; t += 1) tt[t].m(U, null);
            u(U, z), u(U, I), u(I, V), u(U, W), u(U, J), u(J, G), u(s, K), u(s, Q), X || (Y = [g(a, "click", e[0]), g(x, "click", xt), g(A, "click", wt), g(j, "click", Et), g(q, "click", yt), g(P, "click", $t), g(V, "click", e[2]), g(G, "click", Ct)], X = !0)
        },
        p(t, [e]) {
            if (0 & e) {
                let n;
...
function Yt(e) {
    let n, r, o, s, l, i, a, p, $, w, x, E = e[0].displayName + "";
    return {
        c() {
            n = m("div"), r = m("button"), r.textContent = "◄", o = v(), s = m("div"), l = h("SOURCE "), i = m("span"), a = h(E), p = v(), $ = m("button"), $.textContent = "►", y(r, "class", "previous cursor-pointer svelte-zwh9ot"), y(r, "aria-label", "previous channel"), y(s, "class", "channel"), y($, "class", "next cursor-pointer svelte-zwh9ot"), y($, "aria-label", "next channel"), y(n, "class", "channel-controller svelte-zwh9ot")
        },
        m(t, e) {
            d(t, n, e), u(n, r), u(n, o), u(n, s), u(s, l), u(s, i), u(i, a), u(n, p), u(n, $), w || (x = [g(r, "click", $t), g($, "click", yt)], w = !0)
        },
        p(t, [e]) {
...
function ee(e) {
    ...
    return {
        c() {
            n = m("button"), n.textContent = "WARP", y(n, "class", "cursor-pointer svelte-6brq6f")
        },
        m(t, e) {
...
var ce = function () {
    ...
    return function (e, n) {
        ...
        var l, i, a, u, d, f, p, m, h, v, g, y, b = 0,
            $ = [];
        for (l = 0; l < r; l++) $.push(l + 1), $.push(e.charCodeAt(s + l));
        for (var w = $.length - 1; b < o - 3;)
            for (h = n.charCodeAt(s + (i = b)), v = n.charCodeAt(s + (a = b + 1)), g = n.charCodeAt(s + (u = b + 2)), y = n.charCodeAt(s + (d = b + 3)), f = b += 4, l = 0; l < w; l += 2) i = t(p = $[l], i, a, h, m = $[l + 1]), a = t(i, a, u, v, m), u = t(a, u, d, g, m), f = t(u, d, f, y, m), $[l] = f, d = u, u = a, a = i, i = p;
        for (; b < o;)
            for (h = n.charCodeAt(s + (i = b)), f = ++b, l = 0; l < w; l += 2) p = $[l], $[l] = f = t(p, i, f, h, $[l + 1]), i = p;
        return f
    }
}();
...
async function ve(t) {
    ...
    pt.set(rt), Q((() => {
        me({
            title: e,
            slots: n
        }), document.title = e, it.scrollTop = 0, window.history.pushState({
            title: e,
            slots: n
        }, e, t), ue = Z.pathname
    }))
...
function Ce(t) {
    "Enter" === t.key && (t.preventDefault(), ye()), " " === t.key && t.preventDefault(), $e()
}
